...
```{r, results='hide'}
intersect_meta <- jsonlite::fromJSON(here("data", "BCC", "traffic", "raw", "locations",
...
# library(xlsx)
# write.xlsx(intersect_meta, here("data", "BCC", "traffic", "clean",
#                         "intersect_meta.xlsx"))
```
...
st_write(coordinates_sf, 
         "\\\\gpem-atlas2/QCPR/Projects/ABS Linkage/Data/geo/ABS/clean/BCC_traffic_locations.shp", 
         delete_layer = TRUE)
```
...
**TODO: find missing coordinates using `arms$streetName`**
